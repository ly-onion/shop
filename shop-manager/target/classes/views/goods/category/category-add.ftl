                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" value="${ctx}/upload/category/2016/04-02/56ffa1252fb1b.jpg"
                                           name="image" id="image" class="form-control large" readonly="readonly"
